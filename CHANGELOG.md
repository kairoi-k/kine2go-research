...
Frozen single-reference conditional-AMP baseline and three-seed seam JSON record.
...
- Ruff lint/format; `quant_eval_v5.py` is excluded so its recorded hash stays intact.
